...
\begin{itemize}
  \item Library providing a 'Semiring' typeclass, along with instances for all relevant types in \lang{Haskell}'s base library, as well as some generally useful Semiring newtypes.
\end{itemize}
