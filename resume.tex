...
\item Setup and maintained a \wlink{https://github.com/NixOS/hydra}{Hydra server} for use as GitHub \wlink{https://en.wikipedia.org/wiki/Continuous_integration}{CI}. This server was capable of distributing pre-built binaries to developers.
\end{itemize}
}
